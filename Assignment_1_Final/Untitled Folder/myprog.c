...
static MyThread* ready_queue;
static MyThread* blocked_queue;
static MyThread* semaphore_blocked_queue;
...
int MyThreadJoin(MyThread2 thread_light)
{
	MyThread2 thread = (MyThread2)thread_light;
...
MyThread2 MyThreadCreate (void(*start_funct)(void *), void *args) //Finalizes Create Thread Function
{
